...
export default function ImageDropZone() {
  ...
  return (
    <section onDragOver={onDragOver} onDrop={OnDrop} onDragOver={(e) => e.preventDefault()} onDropCapture={(e)} className="border-2 border-dashed border-gray-400 p-4 text-center">
